...
export const RESULTS_DISCLAIMER = "Ces estimations sont basées sur les informations fournies et des données de marché générales. Une évaluation précise nécessite une visite du bien.";
...
export const LABEL_ESTIMATE_UTILITIES = "Inclure une estimation des charges locatives (eau, électricité, internet)?";
export const HELP_TEXT_ESTIMATE_UTILITIES = "Cochez si vous souhaitez une estimation des charges récupérables sur le locataire (pour Conciergerie).";
