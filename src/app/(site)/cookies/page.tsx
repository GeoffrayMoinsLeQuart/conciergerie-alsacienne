...
import { cookiePolicySchema } from '@/app/config/pageSchema';
...
export const metadata: Metadata = getMetadata('cookies');

const CookiesPage: FC = () => {
  const pageKey = 'cookies';
  const baseKey = 'CookiePolicy';
  ...
  return (
    <>
      <SeoSchemaInjector schema={cookiePolicySchema} />
