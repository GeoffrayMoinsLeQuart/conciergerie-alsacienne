        ...
        <div className="container">
          ...
          <div className="mt-14 rounded-lg bg-white p-8 shadow-md">
            ...
            <p className="mb-5 text-center text-base font-medium leading-relaxed text-body-color">
              ...
              potentiel. Notre processus d'évaluation n'est pas simplement un
              filtre, mais une opportunité de valorisation.
            </p>
            <p className="text-center text-base font-medium leading-relaxed text-body-color">
              Lorsqu'un bien ne répond pas encore à tous nos critères, nous ne
              le refusons pas définitivement - nous vous proposons plutôt un
              parcours d'amélioration personnalisé grâce à notre service
              d'accompagnement pour la décoration et l'aménagement, disponible
              en formules Standard et Luxe.
            </p>
          </div>
        </div>
      </section>
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-base font-medium text-body-color">
                      ...
                      <strong>photos professionnelles</strong> (200€-400€ pour
                      l'ensemble)
                    </span>
                  </li>
                </ul>
