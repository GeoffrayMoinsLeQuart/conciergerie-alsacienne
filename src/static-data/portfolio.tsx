...
const portfolioDetails = (
  <div>
    <p className="mb-8 text-base text-body-color sm:text-lg lg:text-base xl:text-lg">
      ...
      <strong>vue panoramique</strong> et un cadre de vie exceptionnel pour séduire une clientèle
      premium. Un bien pensé pour maximiser lexpérience client et la rentabilité.
    </p>
    ...
    <ul className="list mb-7 list-inside list-disc">
      <li className="mb-3 text-base text-primary sm:text-lg lg:text-base xl:text-lg">
        <span className="text-body-color">
          📍 <strong>Emplacement idéal</strong> : proche des commodités et des transports.
        </span>
      </li>
      <li className="mb-3 text-base text-primary sm:text-lg lg:text-base xl:text-lg">
        <span className="text-body-color">
          🏢 <strong>10ᵉ étage</strong> : vue imprenable, luminosité optimale et calme absolu.
        </span>
      </li>
      <li className="mb-3 text-base text-primary sm:text-lg lg:text-base xl:text-lg">
        <span className="text-body-color">
          🛋 <strong>Design et confort</strong> : mobilier moderne, décoration soignée et literie
          premium.
        </span>
      </li>
      <li className="mb-3 text-base text-primary sm:text-lg lg:text-base xl:text-lg">
        <span className="text-body-color">
          🔌 <strong>Équipements complets</strong> : WiFi rapide, Smart TV, cuisine équipée.
        </span>
      </li>
    </ul>
    ...
    <ul className="list mb-7 list-inside list-disc">
      <li className="mb-3 text-base text-primary sm:text-lg lg:text-base xl:text-lg">
        <span className="text-body-color">
          🎯 <strong>Tarification dynamique</strong> : ajustement automatique pour maximiser le
          revenu.
        </span>
      </li>
      <li className="mb-3 text-base text-primary sm:text-lg lg:text-base xl:text-lg">
        <span className="text-body-color">
          🏠 <strong>Taux doccupation optimisé</strong> : gestion stratégique pour limiter les
          périodes creuses.
        </span>
      </li>
      <li className="mb-3 text-base text-primary sm:text-lg lg:text-base xl:text-lg">
        <span className="text-body-color">
          🛠 <strong>Maintenance proactive</strong> : suivi régulier et réactivité en cas
    ...
    <ul className="list mb-7 list-inside list-disc">
      <li className="mb-3 text-base text-primary sm:text-lg lg:text-base xl:text-lg">
        <span className="text-body-color">
          🔑 <strong>Accès autonome</strong> : serrure connectée pour une arrivée flexible et sans
          contrainte.
        </span>
      </li>
      <li className="mb-3 text-base text-primary sm:text-lg lg:text-base xl:text-lg">
        <span className="text-body-color">
          ⭐ <strong>Expérience premium</strong> : ménage soigné, services sur-mesure et accueil
          personnalisé.
        </span>
      </li>
      <li className="mb-3 text-base text-primary sm:text-lg lg:text-base xl:text-lg">
