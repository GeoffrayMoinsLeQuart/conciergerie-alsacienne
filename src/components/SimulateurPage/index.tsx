...
export default function SimulateurPage() {
  ...
  const calculateEstimation = () => {
    ...
    const finishingBonus =
      formData.finishingLevel === 'premium' ? 100 : formData.finishingLevel === 'luxe' ? 200 : 0;
    ...
    if (activeTab === 'gestion') {
      ...
      monthlyMin = Math.round(
        (basePrice * surfaceFactor + parkingBonus + furnishedBonus + finishingBonus) * 0.9,
      );
      monthlyMax = Math.round(
        (basePrice * surfaceFactor + parkingBonus + furnishedBonus + finishingBonus) * 1.1,
      );
    } else {
      // Calcul pour la conciergerie (revenus plus élevés)
      const ambianceBonus =
        formData.ambiance === 'design' || formData.ambiance === 'moderne' ? 100 : 0;
      const qualityBonus =
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="md:col-span-2">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Saisissez l'adresse complète pour une estimation précise (uniquement en Alsace)
              </p>
            </div>
            ...
            {addressData && (
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div>
                  <label className="mb-2 block font-medium text-gray-700">Ville</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="mb-2 block font-medium text-gray-700">Code postal</label>
                  <input
                    type="text"
                ...
                <div className="md:col-span-2">
                  <label className="mb-2 block font-medium text-gray-700">Département</label>
                  <input
                    type="text"
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <div>
                <label className="mb-2 block font-medium text-gray-700">Étage</label>
                <select
                  name="floor"
              ...
              <div>
                <label className="mb-2 block font-medium text-gray-700">Niveau de finition</label>
                <select
                  name="finishingLevel"
              ...
              <div>
                <label className="mb-2 block font-medium text-gray-700">Garage/Parking</label>
              ...
              <div>
                <label className="mb-2 block font-medium text-gray-700">Meublé</label>
                <div className="flex space-x-4">
                  <label className="flex items-center">
                    <input
                      type="checkbox"
        ...
        <div className="mx-auto max-w-3xl rounded-lg bg-white p-6 shadow-md">
          ...
          <div className="mb-6 grid grid-cols-1 gap-8 md:grid-cols-2">
            <div className="rounded-lg bg-blue-50 p-6">
              <h3 className="mb-3 text-xl font-semibold text-gray-800">Revenus mensuels estimés</h3>
            ...
            <div className="rounded-lg bg-green-50 p-6">
              <h3 className="mb-3 text-xl font-semibold text-gray-800">Revenus annuels estimés</h3>
              <p className="text-3xl font-bold text-green-600">{estimationResults.annualRevenue}</p>
              <p className="mt-2 text-sm text-gray-500">Projection sur 12 mois</p>
            </div>
          </div>

          <div className="mb-8 grid grid-cols-1 gap-8 md:grid-cols-2">
            <div className="rounded-lg bg-purple-50 p-6">
              <h3 className="mb-3 text-xl font-semibold text-gray-800">Taux d'occupation estimé</h3>
            ...
            <div className="rounded-lg bg-amber-50 p-6">
              <h3 className="mb-3 text-xl font-semibold text-gray-800">Rentabilité estimée</h3>
              <p className="text-3xl font-bold text-amber-600">{estimationResults.profitability}</p>
              <p className="mt-2 text-sm text-gray-500">Rapport entre revenus et valeur du bien</p>
            </div>
          </div>

          <div className="space-y-4 text-center">
            <p className="text-gray-700">
              Cette estimation est basée sur les données du marché immobilier en Alsace et les
              caractéristiques de votre bien. Pour une évaluation personnalisée plus précise,
              contactez-nous.
            </p>
