  ...
  return (
    <fieldset className="animate-fadeIn">
      ...
      <div className="mb-4">
        <div className="flex items-start">
          ...
          <label htmlFor="consent" className="text-gray-700">
            J'accepte la politique de confidentialité et le traitement de mes données personnelles pour être contacté(e) par Conciergerie Alsacienne. <span className="text-red-500">*</span>
          </label>
        </div>
      ...
      <div className="text-sm text-gray-500 mt-6">
        <p>
          En soumettant ce formulaire, vous acceptez que les informations saisies soient utilisées pour vous recontacter dans le cadre de votre demande.
          Pour connaître et exercer vos droits, consultez notre <a href="/politique-confidentialite" className="text-primary hover:underline">politique de confidentialité</a>.
        </p>
      </div>
    </fieldset>
  );
