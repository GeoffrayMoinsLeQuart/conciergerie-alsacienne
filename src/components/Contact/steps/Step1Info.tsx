...
const Step1Info: React.FC = () => {
  ...
  return (
    <fieldset className="animate-fadeIn">
      <legend className="text-xl font-semibold text-gray-800 mb-4">Vos informations</legend>
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        <div>
          ...
          <Field
            ...
            aria-required="true"
            aria-invalid={!!values.firstName ? 'false' : 'true'}
        ...
        <div>
          ...
          <Field
            ...
            aria-required="true"
            aria-invalid={!!values.lastName ? 'false' : 'true'}
            className="w-full rounded-lg border border-gray-300 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary transition-shadow"
            placeholder="Votre nom complet"
          />
